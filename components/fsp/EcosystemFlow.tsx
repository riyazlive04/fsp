      ...
      {ecosystem.flow.map((step, i) => {
        ...
        return (
          <li
            ...
            className={cn(
              "relative flex items-baseline gap-4 px-5 py-4 sm:min-h-36 sm:flex-col sm:items-stretch sm:justify-between sm:gap-6 sm:p-5 md:p-6",
          ...
          >
            ...
            <span className="text-lg font-semibold leading-tight tracking-tight">{step}</span>
            {!last && (
