...
export const eventCategories = [
  ...
  { id: "30-days-challenge", label: "30 Days Challenge", description: "Turn learning into action through 30 practical tasks completed over 30 days.", href: "/30-days-challenge" },
  { id: "wednesday-masterclass", label: "Wednesday Masterclass", description: "Learn Something. Apply Something. Every Time.", href: "/community#wednesday-masterclass" },
  { id: "mastermind", label: "FSP Mastermind", description: "Conversations That Make You Think Differently.", href: "/community#mastermind" },
  { id: "catalyst-connect", label: "FSP Catalyst Connect", description: "Connect. Learn. Collaborate.", href: "/community#catalyst-connect" },
  { id: "ttx", label: "FSP TTX", description: "2-Day Transformational Residential Experience", href: "/community#ttx" },
