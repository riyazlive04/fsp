...
const topicMap: TopicEntry[] = [
  ...
  { id: "certification", topicEn: ["certification", "good to great", "certificate"], topicTa: ["சன்னித்திவரல்", "certificate", "good to great"], topicTg: ["certificate kudupingala", "certification pannalam", "good to great"], replyTa: "Good to Great Facilitator Certification FSP learning journey இன் ஒரு பகுதி. இது Learning, Practice, Reflection, Feedback மற்றும் Improvement ஐ cover பண்ணும்.", replyTg: "Good to Great Facilitator Certification FSP learning journey இன் part. இது Learning, Practice, Reflection, Feedback Improvement include பண்ணும்." },
...
function getGreeting(lang: Language): string {
  switch (lang) {
    ...
    default: return "Hi there! 👋 Welcome to FSP. I'm Jarvis. Ask me about FSP programs, certification, community, or how to join!";
  }
}
